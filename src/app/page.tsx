...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#263238] overflow-hidden">
      ...
      {/* Hero Section */}
      <section
        className="relative py-20 flex items-center justify-center overflow-hidden border-b-[16px] border-black"
        style={{
          backgroundImage: "url('/members/Fondo-Techo.webp')",
      ...
      >
        ...
        <Button
          size="lg"
          className="bg-[#76ff03] hover:bg-[#64dd17] text-black border-4 border-black font-black italic uppercase rounded-none px-12 h-20 text-3xl shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all"
          asChild
        >
